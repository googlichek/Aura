...
{
	const bool bBothArePlayers = FirstActor->ActorHasTag(FName("Player")) && FirstActor->ActorHasTag(FName("Player"));
	const bool bBothAreEnemies = FirstActor->ActorHasTag(FName("Enemy")) && FirstActor->ActorHasTag(FName("Enemy"));
